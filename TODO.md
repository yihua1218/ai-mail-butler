...
## Low Priority
- [x] Support switching between multiple AI models via UI.
- [ ] Implement attachment processing (e.g., OCR or summarization). _(Skipped: requires OCR libraries not in current Cargo.toml)_
- [ ] Integrate official Google/Microsoft OAuth 2.0. _(Skipped: requires external service accounts)_
- [x] Add data visualization charts for system analytics.
